...
\item Mexico border crossing - compare with Canada.

\section{Data location}
The raw data used for this analysis is located at \url{Z:\_Epi Team\USCIS} and it is a csv file called USCIS2.csv.  The cleaned dataset is ni.main.RDA which is a R file.  
