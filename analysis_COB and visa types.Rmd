...
``` {r "Yecai TB classification", fig.height=5, fig.width=15, fig.align='center'}
...
```{r "Yecai's visa categories", fig.height=5, fig.width=15, fig.align='center'}
##Yecai's visatypes
